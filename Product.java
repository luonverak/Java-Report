package Report;
import static Report.ListData.list;
...
public class Product extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
       ...
       String qty = jsQty.getValue().toString();
       ...
       if(!id.isEmpty() && !name.isEmpty() && !qty.isEmpty() && !price.isEmpty()){
           ...
           ListData.list.add(new ListData(_id, name, _qty, _price));
           count++;
           total += _qty*_price;
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        Payment pay = new Payment(total,list); 
        if(total==0.0f){
